      ...
      <p className="text-center text-sm text-gray-500">
        {mode === 'signin' ? (
          <>
            ...
            <button onClick={() => setMode('signup')} className="text-gray-900 font-medium hover:underline">
              Sign up
            </button>
          </>
        ) : (
          <>
            ...
            <button onClick={() => setMode('signin')} className="text-gray-900 font-medium hover:underline">
              Sign in
            </button>
          </>
        )}
